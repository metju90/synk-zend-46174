...
public class SmbException extends IOException implements NtStatus, DosError, WinError {
    ...
    private SmbTransport smbTransport = null;
    ...
    SmbException( int errcode, Throwable rootCause, SmbTransport smbTrans ) {
        super( getMessageByCode( errcode ));
        status = getStatusByCode( errcode );
        this.rootCause = rootCause;
        this.smbTransport = smbTrans;
    }
    ...
    SmbException( String msg, Throwable rootCause, SmbTransport smbTrans ) {
        super( msg );
        this.rootCause = rootCause;
        this.smbTransport = smbTrans;
        status = NT_STATUS_UNSUCCESSFUL;
    ...
    public SmbTransport getSmbTransport() {
      return this.smbTransport;
    }
